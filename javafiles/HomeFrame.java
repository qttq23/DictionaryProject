...
import javax.imageio.*;
	...
	public class HomeFrame extends DictionaryFrame<String, String>{//extends JFrame{
		...
		private JMenuBar createMenuBar(){
	        ...
	        m2 = new JMenuItem("Meaning"); 
	  		...
	  		m2.addActionListener(new ActionListener(){
			    ...
			    { 
			    	isHistory = false;
			    	changeToFindMeaningMode();

			    	createFindByMeaningWindow(e);
		...
		private JToolBar createToolBar(){
	        ...
	        b1.setToolTipText("Find by meaning");
		...
		public void changeToFindMode(){
			// create a dialog Box 
			dictionaryBus.setDicUsed(true);
	        keysList.setListData(getKeysFromDictionary());
			keysList.setSelectedIndex(0);

			searchLabel.setText("Word");
			listLabel.setText("List");
			searchTextField.setEditable(true);
		}

		public void changeToFindMeaningMode(){
			// create a dialog Box 
			dictionaryBus.setDicUsed(false);
	        keysList.setListData(getKeysFromDictionary());
			keysList.setSelectedIndex(0);

			searchLabel.setText("Meaning");
			listLabel.setText("List");
			searchTextField.setEditable(true);
		}
		...
		public void createEditWindow(ActionEvent e){
	        ...
	        String key = (String)keysList.getSelectedValue();
	        String value = dictionaryBus.search(key);
	        OperationPanel panel = new EditPanel(key, value);
		...
		public void createFindByMeaningWindow(ActionEvent e){
			JDialog d = new JDialog(this, "Find by meaning", Dialog.ModalityType.DOCUMENT_MODAL); 
			d.add(this.bodyPanel);
			...
			d.addWindowListener(new WindowAdapter() {
			    ...
			    public void  windowClosing(WindowEvent e) {
			    	...
			    	pane.revalidate();
					pane.repaint();
			  //       JOptionPane.showMessageDialog(null, "dialog close");
			    }
			});
	        // setsize of dialog 
	        d.pack();
